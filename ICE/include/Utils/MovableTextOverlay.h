...
public:
	...
	void initialize(const Ogre::String & caption, const Ogre::MovableObject *mov, MovableTextOverlayAttributes *attrs);
	...
	int getPixelsTop() {return (int)(Ogre::OverlayManager::getSingleton().getViewportHeight() * (mpOvContainer->getTop()));}
	int getPixelsBottom() {return (int)(Ogre::OverlayManager::getSingleton().getViewportHeight() * (mpOvContainer->getTop() + mpOvContainer->getHeight()));}
	int getPixelsLeft() {return (int)(Ogre::OverlayManager::getSingleton().getViewportWidth() * mpOvContainer->getLeft());}
	int getPixelsRight() {return (int)(Ogre::OverlayManager::getSingleton().getViewportWidth() * (mpOvContainer->getLeft() + mpOvContainer->getWidth()));}
