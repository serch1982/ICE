...
namespace ParticleUniverse
{
	...
	*/
	class _ParticleUniverseExport ScriptTranslator : public Ogre::ScriptTranslator
	{
		public:
			...
			*/
			...
			/** Parse Vector2
			*/
			bool getVector2(AbstractNodeList::const_iterator i, 
			...
			/** Parse Vector3
			*/
			bool getVector3(AbstractNodeList::const_iterator i, 
				AbstractNodeList::const_iterator end, 
				Vector3* result, 
				int maxEntries = 3);
			...
			/** Parse Vector4
			*/
			bool getVector4(AbstractNodeList::const_iterator i, 
				AbstractNodeList::const_iterator end, 
				Vector4* result, 
				int maxEntries = 4);
			...
			/** Parse Quaternion
			*/
			bool getQuaternion(AbstractNodeList::const_iterator i, 
				AbstractNodeList::const_iterator end, 
				Quaternion* result, 
				int maxEntries = 4);
			...
			/** Validate a property.
			*/
			bool passValidateProperty(ScriptCompiler* compiler, 
			...
			*/
			bool passValidatePropertyNoValues(ScriptCompiler* compiler, 
				PropertyAbstractNode* prop, 
				const String& token);

			/** Validate whether the number of values is correct.
			*/
			bool passValidatePropertyNumberOfValues(ScriptCompiler* compiler, 
				PropertyAbstractNode* prop, 
				const String& token,
			...
			*/
			bool passValidatePropertyNumberOfValuesRange(ScriptCompiler* compiler, 
				PropertyAbstractNode* prop, 
				const String& token,
